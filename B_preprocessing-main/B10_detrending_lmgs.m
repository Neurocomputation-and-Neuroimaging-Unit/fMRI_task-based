function B10_detrending_lmgs(Pin,overwrite,prefix,display,GM)
...
% sessions (runs) using LMGS method
    ...
    % @(#)cspm_lmgs.m	1.3 Paul Macey 2007-08-13
...
function detrend_onesession(P,overwrite,prefix,display,GM,sn,num_sessions)
    ...
    for z = 1:dim3
        ...
        s = warning; warning off %#ok<WNOFF>
