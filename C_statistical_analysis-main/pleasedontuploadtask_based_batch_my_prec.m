...
excludeSJ = [3 4] % delete those sjs
...
analysis_switch = [3 4 5]; % 1 2 3 4 5
start_prefix='wrba'; %eg. s8wra
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%# step 4:  2nd level
outputfolder_2nd = '2nd_level_something';
dir_1st   =  beta_dir;
cnames_2nd = cnames;
...
%                             this_log = readtable([src_dir filesep SJs{s} filesep 'func' filesep 'fmri_log_run' num2str(r) '.txt']);
            			    ...
            			    % cond 1: WM level 1
            			    onsets{s,r,1} = this_log.onset(this_log.StimLevel==1); %%% change to struct with onsets.irgendwas{
            			    % cond 2: WM level 2
            			    onsets{s,r,2} = this_log.onset(this_log.StimLevel==2);
            			    % cond 3: WM level 3
            			    onsets{s,r,3} = this_log.onset(this_log.StimLevel==3);
            			    % cond 4: WM level 4
            			    onsets{s,r,4} = this_log.onset(this_log.StimLevel==4);
