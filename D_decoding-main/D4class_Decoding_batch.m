function D4class_Decoding_batch(beta_dir, output_dir, labelnames, dec_type, rad, masks)
...
cfg.results.output = {'accuracy_minus_chance','confusion_matrix','specificity', 'AUC', 'corr', 'zcorr'};
